var totalVertex = 9;
var vertices = [new Vertex(725,338,0,0),new Vertex(832,208,0,0),new Vertex(1012,208,0,0),new Vertex(1193,208,0,0),new Vertex(1311,340,0,0),new Vertex(1223,474,0,0),new Vertex(1057,474,0,0),new Vertex(864,474,0,0),new Vertex(1027,382,0,0)];
var adjMat = [[0, 4, 0, 0, 0, 0, 0, 8, 0],[4, 0, 8, 0, 0, 0, 0, 11, 0],[0, 8, 0, 7, 0, 4, 0, 0, 2],[0, 0, 7, 0, 9, 14, 0, 0, 0],[0, 0, 0, 9, 0, 10, 0, 0, 0],[0, 0, 4, 14, 10, 0, 2, 0, 0],[0, 0, 0, 0, 0, 2, 0, 1, 6],[8, 11, 0, 0, 0, 0, 1, 0, 7],[0, 0, 2, 0, 0, 0, 6, 7, 0]];
var processed;
var isTakingInput;
var isAddingVertex;
var snapShots = [];
